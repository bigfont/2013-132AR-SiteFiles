...
namespace AppLimit.CloudComputing.SharpBox.StorageProvider.DropBox.Logic
{
    ...
    {        
        public static String RequestResourceByUrl(String url, IStorageProviderService service, IStorageProviderSession session)
        {
            return RequestResourceByUrl(url, null, service, session);
        }

        public static String RequestResourceByUrl(String url, Dictionary<String, String> parameters, IStorageProviderService service, IStorageProviderSession session)
        {
            ...
            Stream s = svc.PerformWebRequest2(request, null);            
            if (s == null)
                return "";
