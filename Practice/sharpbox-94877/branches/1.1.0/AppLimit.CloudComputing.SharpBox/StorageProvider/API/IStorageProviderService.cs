...
namespace AppLimit.CloudComputing.SharpBox.StorageProvider.API
{
    ...
    internal interface IStorageProviderService
    {
        ...
        /// <summary>
        /// Generates a valid file object without query the server
        /// </summary>
        /// <param name="session"></param>
        /// <param name="Name"></param>
        /// <param name="parent"></param>        
        /// <returns></returns>
        ICloudFileSystemEntry CreateFileSystemEntry(IStorageProviderSession session, string Name, ICloudDirectoryEntry parent);

        /// <summary>
        /// Generates a valid directory object without query the server
        /// </summary>
        /// <param name="session"></param>
        /// <param name="Name"></param>
        /// <param name="parent"></param>
        /// <returns></returns>
        ICloudDirectoryEntry CreateDirectoryEntry(IStorageProviderSession session, string Name, ICloudDirectoryEntry parent);
        ...
        /// <param name="token"></param>
        void StoreToken(IStorageProviderSession session, List<string> tokendata, ICloudStorageAccessToken token);

        /// <summary>
        /// Loads the information from a token stream 
        /// </summary>
        ICloudStorageAccessToken LoadToken(IStorageProviderSession session, List<string> tokendata);
