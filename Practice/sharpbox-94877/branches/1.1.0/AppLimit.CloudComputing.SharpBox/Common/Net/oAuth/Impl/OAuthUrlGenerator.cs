...
namespace AppLimit.CloudComputing.SharpBox.Common.Net.oAuth.Impl
{
    internal class OAuthUrlGenerator
    {
        ...
        {
            return GenerateSignedUrl(baseRequestTokenUrl, ValidRequestMethod.Get, context, null);            
        }
        ...
        {
            return GenerateSignedUrl(baseAccessTokenUrl, ValidRequestMethod.Get, context, requestToken);            
        }

        static private String GenerateSignedUrl(String baseRequestTokenUrl, ValidRequestMethod method, OAuthConsumerContext context, OAuthToken token)
        {
        ...
        static public String GenerateSignedUrl(String baseResourceUrl, ValidRequestMethod method, OAuthConsumerContext context, OAuthToken token, Dictionary<String, String> urlParameter)
        {            
