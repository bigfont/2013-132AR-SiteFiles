...
namespace AppLimit.CloudComputing.SharpBox.DropBox
{
    ...
    /// </summary>
    public class DropBoxCredentialsToken : DropBoxBaseCredentials, ICloudStorageCredentials
    {
        ...
        public DropBoxCredentialsToken(string consumerKey, string consumerSecret, ICloudStorageAccessToken accessToken)
        {
