...
namespace AppLimit.CloudComputing.SharpBox.DropBox.Objects
{
    internal class DropBoxDirectoryEntry : DropBoxFileSystemEntry, ICloudDirectoryEntry
    {
        ...
        public DropBoxDirectoryEntry(DropBoxApplication associatedApplication, DropBoxSession associatedSession, String name, ICloudDirectoryEntry parent)
            : base(associatedApplication, associatedSession, name, parent)
        {}
        ...
        protected override Boolean BuildEntry(JsonHelper json)
        {
		    ...
		    // set the length
            this.Length = _subDirectories.Count;
