...
namespace AppLimit.CloudComputing.SharpBox.NUnit
{
    ...
    public class DropBoxFileStreamTest : DropBoxBaseTest
    {
        ...
        public void UploadBinaryComfortTest()
        {
            ...
            // upload the file 
            Assert.IsNotNull(CloudStorage.UploadFile(filePath, "/Public"));
        }
        ...
        public void DownloadGifTest()
        {
            ...
            // read the data
            Byte[] dataBuffer = new Byte[readFile.Length];
            int iReadBytes = data.Read(dataBuffer, 0, (int)readFile.Length);
        ...
        void TestFileOperationProgressChanged(ICloudFileSystemEntry file, long currentbytes, long sizebytes)
        {
            Console.WriteLine("Progress: {0} of {1} ({2}%)", currentbytes, sizebytes, (100 * currentbytes) / sizebytes);
        }
        ...
        public void UploadPPTXFile()
        {
            ...
            // upload file
            CloudStorage.UploadFile("C:\\" + fileName, publicFolder, TestFileOperationProgressChanged);
 
            // download file
            String targetDir = Environment.GetEnvironmentVariable("temp");
            CloudStorage.DownloadFile(publicFolder, fileName, targetDir, TestFileOperationProgressChanged);
        ...
        public void VerifyFileAttributes()
        {
            ...
            // get the file
            ICloudFileSystemEntry file = publicFolder.GetChild("xxx.pptx");
        ...
        [Test()]
        public void TestDirectDownloadUrl()
        {
            // open the publicFilder
            ICloudDirectoryEntry publicFolder = CloudStorage.GetFolder("/Public");

            // get the direct url to the pptx
            Uri uri = CloudStorage.GetFileSystemObjectUrl("xxx.pptx", publicFolder);
