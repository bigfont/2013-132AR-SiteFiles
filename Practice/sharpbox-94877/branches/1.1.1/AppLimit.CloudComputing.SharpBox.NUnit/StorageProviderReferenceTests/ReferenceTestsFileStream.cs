...
namespace AppLimit.CloudComputing.SharpBox.NUnit.StorageProviderReferenceTests
{
    partial class GenericReferenceTests : ReferenceBaseTest 
    {
        ...
        public void FileUploadFileRoutine(String fileNameFromClientData, Boolean bInterrupManually)
        {
            // set the names
        ...
        {
            FileUploadFileRoutine("DirectUploadTest.bmp", false);
            FileUploadFileRoutine("Glück.pdf", false);
        }

        [Test()]
        public void FileUploadABorted()
        {            
            FileUploadFileRoutine("Glück.pdf", true);
        }               
        ...
        public void FileTestDirectDownloadUrl()
        {
            ...
            if (Credentials is ICredentials)
            {
                ICredentials creds = Credentials as ICredentials;
