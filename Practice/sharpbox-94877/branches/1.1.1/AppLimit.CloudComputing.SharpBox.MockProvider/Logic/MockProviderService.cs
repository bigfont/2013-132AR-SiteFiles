...
namespace AppLimit.CloudComputing.SharpBox.MockProvider.Logic
{
    ...
    internal class MockProviderService : GenericStorageProviderService
    {
        ...
        {
            if (credentials is MockProviderCredentials)
                return true;
            else
                return false;            
        }
        ...
        public override IStorageProviderSession CreateSession(ICloudStorageCredentials credentials, ICloudStorageConfiguration configuration)
        {
            ...
            return new MockProviderSession(credentials as MockProviderCredentials, this, configuration as MockPoviderConfiguration);
        }
