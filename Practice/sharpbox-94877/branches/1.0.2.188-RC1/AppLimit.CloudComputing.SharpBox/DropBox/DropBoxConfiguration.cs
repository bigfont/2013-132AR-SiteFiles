...
namespace AppLimit.CloudComputing.SharpBox.DropBox
{
    ...
    {        
        ...
        {
			return new Uri("http://" + DropBoxApplication.DropBoxServer + "/0/oauth/request_token");
        }
        ...
        {
			return new Uri("http://" + DropBoxApplication.DropBoxServer + "/0/oauth/access_token");
        }
        ...
        {
			return new Uri("http://" + DropBoxApplication.DropBoxServer + "/0/oauth/authorize");
        }
